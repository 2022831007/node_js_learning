...
// des:simple node application that print random quotes per second Interval 
// author:Fatema
// date:26/5/2026


// dependencies
//which file we take from outside is meant to be dependencies
const mathLibrary=require('./lib/math');
const quotesLibrary=require('./lib/quotes');

//app object-module scaffolding-means a row basic structure
const app={};
//configuration
app.config={
    timeBetweenQuotes:1000,
}; //after every 1000 miliseconds,quotes will be appear
